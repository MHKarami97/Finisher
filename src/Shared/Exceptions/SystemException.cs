...
public static class ExceptionInfo
{
    ...
    public static readonly SystemExceptionType Error400 = new(nameof(Messages.BadRequestExeption), Messages.BadRequestExeption, Messages.BadRequestExeptionUserAction);
